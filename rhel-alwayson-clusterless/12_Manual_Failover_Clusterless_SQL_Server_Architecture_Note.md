...
echo "[5/5]: Re-establishing data replication stream pipeline. Resuming HADR on database [PayLab]..."
sqlcmd -S "$primarydbserver" -U "$dbusername" -P "$dbpassword" -C -Q "ALTER DATABASE [PayLab] SET HADR RESUME;"
