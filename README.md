...
| Component Host / Name | System Hardware Specs | Monthly Compute Hardware | Monthly SQL License (PAYG) | 🟥 Monthly Windows OS Fee | 🐧 Monthly Linux OS Fee | 🏛️ Model 1: Upfront Perpetual License<br>(Year 1 Base vs. Year 2+ SA Cost) | 🟢 Net Capital Saved (Linux OS Only) |
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| **db1** <br>*(Primary Replica)* | 8 vCPU / 64 GB RAM <br>32 GB OS / 1000 GB Data | `$472.92`<br>*(Yearly: $5,675.04)* | `$2,190.00`<br>*(Yearly: $26,280.00)* | `$268.64`<br>*(Yearly: $3,223.68)* | **`$0.00`** | **Year 1:** `$60,492.00` <br>⏳ **Year 2+:** `$15,123.00 / yr` *(SA)* | **`$268.64 / mo`**<br>*(Yearly: $3,223.68)* |
| **db2** <br>*(Active Readable Secondary)* | 8 vCPU / 64 GB RAM <br>32 GB OS / 1000 GB Data | `$472.92`<br>*(Yearly: $5,675.04)* | `$2,190.00`<br>*(Yearly: $26,280.00)* | `$268.64`<br>*(Yearly: $3,223.68)* | **`$0.00`** | **Year 1:** `$60,492.00` <br>⏳ **Year 2+:** `$15,123.00 / yr` *(SA)* | **`$268.64 / mo`**<br>*(Yearly: $3,223.68)* |
| **db-cluster** <br>*(Quorum Witness)* | 2 vCPU / 8 GB RAM <br>32 GB OS / 128 GB Data | `$89.28`<br>*(Yearly: $1,071.36)* | `$0.00`<br>*(Yearly: $0.00)* | `$67.16`<br>*(Yearly: $805.92)* | **`$0.00`** | 🟢 **`$0.00`** <br>*(No SQL Engine Active)* | **`$67.16 / mo`**<br>*(Yearly: $805.92)* |
| **Backup Server** <br>*(Cloud Storage Node)* | 2 vCPU / 8 GB RAM <br>32 GB OS / 500 GB Data | `$124.28`<br>*(Yearly: $1,491.36)* | `$0.00`<br>*(Yearly: $0.00)* | `$67.16`<br>*(Yearly: $805.92)* | **`$0.00`** | 🟢 **`$0.00`** <br>*(No SQL Engine Active)* | **`$67.16 / mo`**<br>*(Yearly: $805.92)* |
| **📈 TOTALS** | **18 vCPU / 136 GB RAM** <br>**2,128 GB Disk Pool** | **`$1,159.40 / mo`**<br>*(Yearly: $13,912.80)* | **`$4,380.00 / mo`**<br>*(Yearly: $52,560.00)* | **`$671.60 / mo`**<br>*(Yearly: $8,059.20)* | **`$0.00 / mo`** | **Year 1 Total:** `$120,984.00` <br>⏳ **Year 2+ Total:** `$30,246.00 / yr` | **`$671.60 / month`**<br>⚠️ **`$8,059.20 / year`** |

### 🎯 Key Financial Takeaways

*   **Windows Total Deployment Cost (PAYG Model):** **`$6,211.00 / mo`** (`$74,532.00 / year`)
*   **Linux Total Deployment Cost (PAYG Model):** **`$5,539.40 / mo`** (`$66,472.80 / year`)
*   **Financial Bottom Line:** Switching your database architecture to a high-availability Linux environment keeps your hardware capabilities and cloud compute profiles entirely identical while recovering **exactly $8,059.20 per year in pure operating system savings** for every cluster layer deployed! 
*   **The Multi-Year Dividend:** When leveraging the Upfront Perpetual License route (Model 1), the **$8,059.20 annual savings** generated by removing Windows completely covers **over 26% of your Year 2+ Software Assurance maintenance overhead ($30,246.00/yr)** indefinitely.
